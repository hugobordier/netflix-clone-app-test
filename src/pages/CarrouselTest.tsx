...
const ColorCarousel: React.FC = () => {
  return (
    <div
      ...
      data-carousel="slide"
    >
      <div className="relative h-56 overflow-hidden rounded-lg bg-slate-300 md:h-96">
        <div
          className="hidden duration-700 ease-in-out"
          data-carousel-item
        ></div>
        <div
          className="hidden duration-700 ease-in-out bg-lime-900"
          data-carousel-item
        ></div>
        <div
          className="hidden duration-700 ease-in-out bg-sky-50"
          data-carousel-item
        ></div>
        <div
          className="duration-700 ease-in-out bg-purple-300hidden"
          data-carousel-item
        ></div>
        <div
          className="hidden duration-700 ease-in-out bg-teal-50"
          data-carousel-item
        ></div>
      </div>
